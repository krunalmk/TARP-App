package com.kmk.awesomescanner.ui;
...
import com.kmk.awesomescanner.util.Decoder;
import com.kmk.awesomescanner.util.DecoderWrapper;
import com.kmk.awesomescanner.util.ErrorCallback;
import com.kmk.awesomescanner.util.ScanMode;
import com.kmk.awesomescanner.util.AutoFocusMode;
import com.kmk.awesomescanner.util.CodeScannerException;
import com.kmk.awesomescanner.util.DecodeCallback;
import com.kmk.awesomescanner.util.Point;
import com.kmk.awesomescanner.util.Rect;
import com.kmk.awesomescanner.util.Utils;
 ...
 * @see BarcodeFormat
 */
public final class GpCodeScanner {
    ...
    /**
     * GpCodeScanner, associated with the first back-facing camera on the device
     *
     ...
     */
    @MainThread
    public GpCodeScanner(@NonNull final Context context, @NonNull final ScannerView view) {
        mContext = context;
        mScannerView = view;
    ...
    /**
     * GpCodeScanner, associated with particular hardware camera
     *
     * @param context  Context
     * @param view     A view to display the preview
    ...
    public void performTouchFocus(final Rect viewFocusArea) {
        synchronized (mInitializeLock) {
